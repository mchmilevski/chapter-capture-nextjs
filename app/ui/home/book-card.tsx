  ...
  return (
    <div className="bg-white rounded-lg cursor-pointer">
      <div className='p-4 flex'>
        <Image src={cover} width={112} height={0} alt='Book Cover' className='w-28 lg:w-32 h-fit'/>
        <div className='pl-4'>
          <h1 className={`${lusitana.className} antialiased text-[#707070] font-normal line-clamp-1 text-sm`}>{seriesName}</h1>
          <h1 className={`${lusitana.className} font-semibold line-clamp-2`}>{title}</h1>
